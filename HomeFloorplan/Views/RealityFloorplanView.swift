...
struct RealityFloorplanView: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, UIGestureRecognizerDelegate {
        ...
        private func enterRoom(_ roomID: UUID) {
            ...
            // **Al centro della stanza, punto.** Tre giri di algoritmi
            // d'imbocco — rettangolo, poligono, muri veri — e nessuno battava
            // la soluzione ovvia: si entra al centro, quel che si vede si
            // vede, e ci si gira con un dito. La sofisticazione era il bug.
